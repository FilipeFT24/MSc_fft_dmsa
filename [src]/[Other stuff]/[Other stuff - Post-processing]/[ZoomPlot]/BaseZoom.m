classdef BaseZoom < handle
    ...
    properties
        ...
        imageConnectedLineWidth = 0.85
        % setting of start arrow
        imageConnectedLineStartHeadStyle = 'none' % shape of start arrow
        imageConnectedLineStartHeadLength = 3
        imageConnectedLineStartHeadWidth = 3
        % setting of end arrow
        imageConnectedLineEndHeadStyle = 'none' % shape of ending arrow
    ...
    properties
        ...
        figureConnectedLineWidth = 0.25
        % setting of start arrow
        figureConnectedLineStartHeadStyle = 'none' % shape of start arrow
        figureConnectedLineStartHeadLength = 3
        figureConnectedLineStartHeadWidth = 3
        % setting of end arrow
        figureConnectedLineEndHeadStyle = 'none' % shape of ending arrow
    ...
    methods
            ...
            switch obj.axesClass
                ...
                case 'figure'
                    ...
                    for ii = 1:length(children_)
                        if strcmp(children_(ii,1).Type,'images.roi.rectangle') || strcmp(children_(ii,1).Type,'hggroup')
                            numChildren_(ii) = [];
                        end
                    end
        ...
        function connectAxesAndBox(obj)
            switch obj.axesClass
                case 'image'
                    ...
                    obj.imageRectangleEdgePosition(2) = (obj.vPixels-Position_(2)-Position_(4))/vPixelsAll+obj.subAxes.Position(2);
                    ...
                    obj.imageArrow  {2} = annotation(gcf,'doublearrow',annotationPosX_2, annotationPosY_2,...
                            'Color'      ,obj.imageConnectedLineColor,...
                            'LineWidth'  ,obj.imageConnectedLineWidth,...
                            'LineStyle'  ,obj.imageConnectedLineStyle,...
                            'Head1Style' ,obj.imageConnectedLineStartHeadStyle,...
                ...
                case 'figure'
                    ...
                    for i    = 1:numLine
                        tmp1 = [obj.figureRectangleEdgePosition(obj.lineDirection(i,1),1),obj.figureRectangleEdgePosition(obj.lineDirection(i,1),2)];
                        tmp2 = [obj.axesPosition(obj.lineDirection(i,2),1),obj.axesPosition(obj.lineDirection(i,2),2)];
        ...
        function getAxesAndBoxPosition(obj)
            ...
            tmp1   = [obj.subAxes.Position(1)+obj.subAxes.Position(3),obj.subAxes.Position(2)+obj.subAxes.Position(4)];
            box2_1 = obj.transformCoordinate(tmp1, 'n2a');
            tmp2   = [obj.subAxes.Position(1),obj.subAxes.Position(2)+obj.subAxes.Position(4)];
            ...
            tmp4   = [obj.subAxes.Position(1)+obj.subAxes.Position(3),obj.subAxes.Position(2)];
        ...
        function coordinate = transformCoordinate(obj,coordinate,type)
            switch type
                case 'a2n'
                    switch obj.axesScale.XScale
                        case 'linear'
                            coordinate(1,1) = (coordinate(1,1)-obj.mappingParams(1,2))/obj.mappingParams(1, 1);
                        case 'log'
                            coordinate(1,1) = (log10(coordinate(1,1))-obj.mappingParams(1,2))/obj.mappingParams(1, 1);
                    end
                    switch obj.axesScale.YScale
                        case 'linear'
                            coordinate(1,2) = (coordinate(1,2)-obj.mappingParams(2,2))/obj.mappingParams(2, 1);
                        case 'log'
                            coordinate(1,2) = (log10(coordinate(1,2))-obj.mappingParams(2,2))/obj.mappingParams(2, 1);
                    end
                case 'n2a'
                    switch obj.axesScale.XScale
                        case 'linear'
                            coordinate(1,1) = coordinate(1,1)*obj.mappingParams(1,1)+obj.mappingParams(1,2);
                        case 'log'
                            coordinate(1,1) = 10^(coordinate(1,1)*obj.mappingParams(1,1)+obj.mappingParams(1,2));
                    end
                    switch obj.axesScale.YScale
                        case 'linear'
                            coordinate(1,2) = coordinate(1,2)*obj.mappingParams(2,1)+obj.mappingParams(2,2);
                        case 'log'
                            coordinate(1,2) = 10^(coordinate(1,2)*obj.mappingParams(2,1)+obj.mappingParams(2,2));
                    end
            end
        end
