...
switch size(Q.Points,2)
    ...
    case 2
        ...
        scatter(Q.Points( P,1),Q.Points( P,2),500.*Q.Weights( P)./sum(Q.Weights),'Marker','o','MarkerEdgeColor','r','MarkerFaceColor','r');
        scatter(Q.Points(~P,1),Q.Points(~P,2),500.*Q.Weights(~P)./sum(Q.Weights),'Marker','o','MarkerEdgeColor','r','MarkerFaceColor','r');
        scatter(Q.Points( I,1),Q.Points( I,2),500.*Q.Weights( I)./sum(Q.Weights),'Marker','o','MarkerEdgeColor','r','MarkerFaceColor','r');
        scatter(Q.Points(~I,1),Q.Points(~I,2),500.*Q.Weights(~I)./sum(Q.Weights),'Marker','o','MarkerEdgeColor','r','MarkerFaceColor','r');
        daspect([1 1 1]);
        axis([...
