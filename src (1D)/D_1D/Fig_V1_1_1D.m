    ...
    methods (Static)
        ...
        function [] = Plot(obj,msh)
            ...
            if ~exp
                ...
                subplot(1,2,1);
                Fig_V1_1_1D.Plot_1_1(obj,msh,1,fig,[exp,0]);
                subplot(1,2,2);
                Fig_V1_1_1D.Plot_1_2(obj,msh,1,fig,[exp,0]);
                %  > #2.
                figure; set(gcf,'Units','pixels','Position',fig.Position);
                subplot(1,2,1);
                Fig_V1_1_1D.Plot_2_1(obj,msh,1,fig,[exp,0]);
                subplot(1,2,2);
                Fig_V1_1_1D.Plot_2_2(obj,msh,1,fig,[exp,0]);
            else
                %  > #1.
                figure; set(gcf,'Units','pixels','Position',fig.Position);
                Fig_V1_1_1D.Plot_1_1(obj,msh,1,fig,[exp,0]);
        ...
        %% > 2. -----------------------------------------------------------
        % >> 2.1. ---------------------------------------------------------
        function [] = Plot_1_1(obj,msh,n,fig,edt)
            %  > Auxiliary variables.
        ...
        % >> 2.2. ---------------------------------------------------------
        function [] = Plot_1_2(obj,msh,n,fig,edt)
            %  > Auxiliary variables.
            fig.C = linspecer(9,'qualitative');
            fig.M = repelem(":o",2);
        ...
        %% > 3. -----------------------------------------------------------
        % >> 3.1. ---------------------------------------------------------
        function [] = Plot_2_1(obj,msh,n,fig,edt)
            %  > Auxiliary variables.
            Flag  = 0;
            fig.C = linspecer(9,'qualitative');
        ...
        % >> 3.2. ---------------------------------------------------------
        function [] = Plot_2_2(obj,msh,n,fig,edt)
