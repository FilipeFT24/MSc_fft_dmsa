classdef Fig_2_1D
    methods (Static)         
        ...
        function [] = Plot(msh,pde)
            ...
            hold on;
            P1 = plot(msh.c.Xc,pde.E.EA,'-ob','Linewidth',1.0,'MarkerFaceColor','b','MarkerSize',3.5);
            P2 = line([msh.c.Xc(1),msh.c.Xc(msh.c.NC)],[pde.E.EN(1),pde.E.EN(1)],'Color','k','LineStyle','--','Linewidth',0.75);
            ...
            for i = 1:msh.c.NC
                ...
                patch(ToPatch.Cell{i}(1,:),ToPatch.Cell{i}(2,:),pde.E.EA(i));
            end
