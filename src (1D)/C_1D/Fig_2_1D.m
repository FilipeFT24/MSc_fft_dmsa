classdef Fig_2_1D
    methods (Static)         
        %% > Figure 2 (1D)
        function [] = WrapUp_Fig_2_1D(msh,X,Norm)
...
%             elseif strcmpi(obj.Sim_Type,'Implicit') || strcmpi(obj.Sim_Type,'DC')
                %  > Subplot 1.
                Fig_2_1D.Subplot_1(msh,X);
                %  > Subplot 2.
                Fig_2_1D.Subplot_2(msh,X);
                %  > Subplot 3.
                Fig_2_1D.Subplot_3(msh,X,Norm);
                %  > Subplot 4.
                Fig_2_1D.Subplot_4(msh,X);
%             end
        end
        ...
        function [] = Subplot_1_EX(msh,X)
            ...
            Fig_Tools_1D.ChangeLook_1(msh.Xv(1),msh.Xv(msh.NV),10);
        end
        %  > Subplot 2.
        function [] = Subplot_2_EX(msh,X)
            ...
            c = Fig_Tools_1D.Colormap_cmocean();
            c.Label.String = '$\phi$';
        ...
        function [] = Subplot_1(msh,X)
            ...
            set(colorbar,'Visible','off'); 
            hold on;
            P1 = plot(msh.c.Xc,X.Phi    ,'-k','Linewidth',1.0);
            P2 = plot(msh.c.Xc,X.Phi_PDE,'or','MarkerFaceColor','r','MarkerSize',3.5);
