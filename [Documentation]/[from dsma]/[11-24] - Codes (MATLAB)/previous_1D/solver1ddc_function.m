function [numero_condicao,fl0,Peclet_number, Lref, norma1_phi, erro_phi_max]=solver1ddc_function(metodo1)
%
...
%% Dados de Input %%
%
uniforme=false;                       % Tipo de Malha -----------------------> true----->Malha Uniforme       false---->Malha Não Uniforme %
%metodo1='8thOrder';                  % Metedo Numerico Alta Ordem ----------> 2ndOrder->Método de 2ª Ordem   4thOrder->Método de 4ª Ordem    6thOrder->Método de 6ª Ordem    8thOrder->Método de 8ª Ordem %
...
plots=false; % Plot dos Resultados %
escrita_no_ficheiro = false; 
%
% cell_num=300;                        % Numero de Células em que o dominio deve ser dividido %
...
%
% u_convec = 25;                         % Parametro da velocidade convectiva 
% gamma_diff = -0.1;                       % Parametro da contribuição da difusividade
