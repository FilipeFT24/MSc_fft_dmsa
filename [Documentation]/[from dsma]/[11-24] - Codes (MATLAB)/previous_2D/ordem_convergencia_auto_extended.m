...
global u_convec_x u_convec_y gamma_diff numero_condicao cell_side Lref robin face_w_gauss mix_method G solution T_border restos constrained_source neuman extended_stencil increase_gauss_points exact_coeffs dimensional_correction;%

save_results=true;
erro_fitting_poly = true;

max_iter = 6;

cellnum = [10 36 53 72 97 140 183 227 270 316 357 400];
cellnum=cellnum;
...
% 
% [Lref, norma1_phi, erro_phi_max, erro_medio_poly, erro_max_poly]=solver2d_function('WLS_8');
% vector_save8_3(iter,:)=[Lref norma1_phi erro_phi_max erro_medio_poly erro_max_poly];
...
loglog(vector_save8_1(:,1), vector_save8_1(:,4), '--','color','k','MarkerFaceColor', 'k')
hold on
loglog(vector_save8_2(:,1), vector_save8_2(:,4), '--','color','r')
% loglog(vector_save8_3(:,1), vector_save8_3(:,4), '--','color','b')
loglog(vector_save8_1(:,1), vector_save8_1(:,2), 'd-','color','k','MarkerFaceColor', 'k')
loglog(vector_save8_2(:,1), vector_save8_2(:,2), 'o-','color','r','MarkerFaceColor', 'r')
% loglog(vector_save8_3(:,1), vector_save8_3(:,2), '^-','color','b','MarkerFaceColor', 'b')
...
loglog(vector_save8_1(:,1), vector_save8_1(:,5), '--','color','k','MarkerFaceColor', 'k')
hold on
loglog(vector_save8_2(:,1), vector_save8_2(:,5), '--','color','r')
% loglog(vector_save8_3(:,1), vector_save8_3(:,5), '--','color','b')
loglog(vector_save8_1(:,1), vector_save8_1(:,3), 'd-','color','k','MarkerFaceColor', 'k')
loglog(vector_save8_2(:,1), vector_save8_2(:,3), 'o-','color','r','MarkerFaceColor', 'r')
% loglog(vector_save8_3(:,1), vector_save8_3(:,3), '^-','color','b','MarkerFaceColor', 'b')
...
% loglog(vector_save4(:,1), vector_save4(:,2), 'o-','color','g','MarkerFaceColor', 'g')
% loglog(vector_save6(:,1), vector_save6(:,2), '^-','color','b','MarkerFaceColor', 'b')
loglog(vector_save8unc(:,1), vector_save8unc(:,2), 'd-','color','k','MarkerFaceColor', 'k')
 hold on
loglog(vector_save8con(:,1), vector_save8con(:,2), 'o-','color','r','MarkerFaceColor', 'r')
% loglog(vector_save8mix(:,1), vector_save8mix(:,2), '^-','color','b','MarkerFaceColor', 'b')
...
% loglog(vector_save4(:,1), vector_save4(:,3), 'o-','color','g','MarkerFaceColor', 'g')
% loglog(vector_save6(:,1), vector_save6(:,3), '^-','color','b','MarkerFaceColor', 'b')
loglog(vector_save8unc(:,1), vector_save8unc(:,3), 'd-','color','k','MarkerFaceColor', 'k')
 hold on
loglog(vector_save8con(:,1), vector_save8con(:,3), 'o-','color','r','MarkerFaceColor', 'r')
% loglog(vector_save8mix(:,1), vector_save8mix(:,3), '^-','color','b','MarkerFaceColor', 'b')
...
% legend({ '\bf ERROR POLY Tangent OFF', '\bf ERROR POLY Tangent ON', '\bf Tangent OFF','\bf Tangent ON'},'Location', 'East','FontSize',12)
legend({ '\bf ERROR TANGENT OFF', '\bf ERROR TANGENT ON', '\bf ERROR DIRECT', '\bf TANGENT OFF' ,'\bf TANGENT ON','\bf DIRECT'},'Location', 'East','FontSize',12)
...
beep
matlabmail('filipe.diogo@tecnico.ulisboa.pt', 'FEITO', 'BANDIDO_LASEF')